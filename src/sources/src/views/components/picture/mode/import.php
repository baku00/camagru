<div class="text-center">
	<div class="preview">
		<img data-picture="picture" src="" alt="" class="picture" />
		<img data-superposition="picture" src="" alt="" class="superposition" />
	</div>
	<div class="d-block">
		<div class="mt-3">
			<button data-picture="publish" class="btn btn-primary me-3 d-none" id="publish-picture" disabled data-event on-click="uploadPicture">Publier</button>
			...
			<input type="file" id="select-picture" data-event on-change="changePicture" class="d-none">
